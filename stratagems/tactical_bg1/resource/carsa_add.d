...
SAY ~AAAHhhh...! Stop his screaming, stop it, please! I can't bear it any more!~
IF ~Global("dw_told_of_jar","LOCALS",1)~ THEN REPLY ~I can make it stop. You just have to give me the jar.~ GOTO 5
...
SAY ~The whispering.. the screams... gone... I thought no-one could stop it...~
=
~But still, so much blood, so many dead... what will poor Carsa do now, how can she sleep?~
IF ~~ THEN REPLY ~The village of Gullykin is only a few hours north of here, and I can give you supplies. The halflings will be able to look after you while you recover from this ordeal.~ DO ~SetGlobal("dw_carsa_gullykin","GLOBAL",1)~ GOTO to_gullykin
IF ~~ THEN REPLY ~Why should I care? Get out of here, I've got more important things to worry about.~ GOTO get_lost
IF ~~ THEN REPLY ~Once I cut you down for nearly getting me killed, that won't be a problem.~ GOTO time_to_die
END

IF ~~ BEGIN to_gullykin
SAY ~Yes... yes, I can do that. Thank you! Thank you for freeing me!~
